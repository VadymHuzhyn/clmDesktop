...
public class CLMConstant {
    ...
    public static final String INIT_CLM_WISHLISTS_TYPE = "CLMWishlistsType = {\"%s\", \"%s\"}\n";
    ...
    public static final String VALUE_IN_LIST = "[%s] = {[\"itemId\"] = %s,[\"marker\"] = %s}";
    public static final String ARRAY_NICKNAME = "[\"%s\"] = {%s}";
